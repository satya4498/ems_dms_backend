...
export class ProviderRemoveRestrictedCountriesService extends ServiceBase {
  get constraints () {
    return constraints
  }
  ...
  async run () {
    ...
    try {
      ...
      provider.restrictedCountries = _.difference(provider.restrictedCountries, countries.countryIds)

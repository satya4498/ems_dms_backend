...
const constraints = ajv.compile({
  ...
  properties: {
    key: {
      enum: [
        USER_RESPONSIBLE_GAMBLING_LIMIT_TYPES.DAILY_PLAY_LIMIT,
        USER_RESPONSIBLE_GAMBLING_LIMIT_TYPES.WEEKLY_PLAY_LIMIT,
        USER_RESPONSIBLE_GAMBLING_LIMIT_TYPES.MONTHLY_PLAY_LIMIT
      ]
    },
    value: { type: 'string' },
    reset: { type: 'boolean' },
...
export class UpdateBettingLimitsService extends ServiceBase {
  get constraints () {
    return constraints
  }

...
export class GetCasinoTransactionsCsvReportService extends ServiceBase {
  get constraints () {
    return constraints
  }
...
: ''}
      ...
      const ledgerQuery = `WITH aggregated_ledger AS (
      SELECT
    ...
    GROUP BY
      l.transaction_id, l.purpose, l.to_wallet_id, l.from_wallet_id, l.currency_id
     )
    SELECT
      ...
      al.type AS "ACTION TYPE",
      cg.id AS "GAME ID",
      cg.name#>>'{EN}' AS "GAME NAME"
    FROM
